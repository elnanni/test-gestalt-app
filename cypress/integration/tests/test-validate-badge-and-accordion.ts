...
describe("Gestalt data test id validation for badge and accordion", () => {
  ...
  it("Validate Accordion", () => {
    ...
    cy.get(GestaltTestPage.ACCORDION_TITLE).should(
      "have.text",
      "Testing Accordion",
    );
  });
  it("Validate badge in accordion", () => {
    ...
    cy.get(GestaltTestPage.BADGE_ACCORDION_TITLE).should(
      "have.text",
      "Testing Badge in Accordion",
    );
  ...
  it("Validate icon button in accordion", () => {
    ...
    cy.get(GestaltTestPage.ICONBUTTON_ACCORDION_TITLE).should(
      "have.text",
      "Testing IconButton in Accordion",
    );
    cy.get(GestaltTestPage.ICONBUTTON_ACCORDION_ICONBUTTON).click();
    cy.get(GestaltTestPage.ICONBUTTON_ACCORDION_POPOVER).should(
      "have.text",
      "Help content!",
    );
  });
